...
\quote{``I learned early on the difference between knowing the name of something and knowing something."}
...
\makecvfooter
  % {\today}
  {}
  {Jefferson Mauricio Beleño Velandia~~~·~~~Curriculum Vitae}
  {\thepage}
